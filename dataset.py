...
After downloading, unzip so the structure is:
    ...
    data/
      animefacedataset/
        images/            (or flat directory — we search recursively)
          000001.jpg
          000002.jpg
          ...
...
class AnimeFaceDataset(Dataset):
    ...
    def __getitem__(self, idx: int) -> torch.Tensor:
        try:
            ...
            # Gracefully skip corrupt images
